...
?>
		...
		<script>
			location.href = 'matriz-de-risco.php?cod=<?php echo $codigo_matriz_de_risco ?>#conteudo2'
		</script>

	<?php } else { ?>

		<script>
			location.href = 'matriz-de-risco.php?cod=<?php echo $codigo_matriz_de_risco ?>#2conteudo2'
		</script>
