        ...
        <div class="col-md-12">
          ...
          <div id="conteudo1">
            ...
            <div class="row">
              ...
              <div style="margin-right:80px">
                ...
                <?php
                $selecao_principal = mysqli_query($conexao, "select * from area_principal_risco WHERE codigo_matriz_risco='$codigo_matriz_risco'");
                while ($registros_principal = mysqli_fetch_array($selecao_principal)) {
                  print $registros_principal['area'];
                ?>
              ...
              <div>
                ...
                <?php
                $selecao_principal = mysqli_query($conexao, "select * from demais_areas_risco WHERE codigo_matriz_risco='$codigo_matriz'");
                while ($registros_principal = mysqli_fetch_array($selecao_principal)) {
                ?>
                  <input type="text" readonly class="form-control" value="<?php echo $registros_principal['area'] ?>">
                <?php } ?>
          ...
          -->
                    ...
                    <div style="margin-right:80px">
                      <label>Principais áreas impactadas pelo risco </label>
                      <?php
                      $selecao_principal = mysqli_query($conexao, "select * from area_principal_risco WHERE codigo_matriz_risco='1'");
                      while ($registros_principal = mysqli_fetch_array($selecao_principal)) {
                      ?>
                        <input type="text" readonly class="form-control" value="<?php echo $registros_principal['area'] ?>">
                      <?php } ?>
                    ...
                    <div>
                      <label>Demais áreas impactadas pelo risco </label>
                      <?php
                      $selecao_principal = mysqli_query($conexao, "select * from demais_areas_risco WHERE codigo_matriz_risco='1'");
                      while ($registros_principal = mysqli_fetch_array($selecao_principal)) {
                      ?>
                        <input type="text" readonly class="form-control" value="<?php echo $registros_principal['area'] ?>">
                      <?php } ?>
              ...
              <div class="modal-body">
                ...
                <div class="row ml-4 mr-6 mt-4 mb-4">
                  ...
                  <div>
                    ...
                    <div class="row col-md-12 mx-0 px-0 mb-4">
