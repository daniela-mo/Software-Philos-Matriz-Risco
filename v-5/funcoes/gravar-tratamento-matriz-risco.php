...
$gravar = mysqli_query($conexao, "insert into workflow(codigo_matriz_risco,planejamento,prioridade,data_inicio,data_vencimento,descricao,tratamento,status,responProc)values('$codigo','$titulo','$prioridade','$data_min','$data_max','$descricao','1','Aberto','$responProc') ");
