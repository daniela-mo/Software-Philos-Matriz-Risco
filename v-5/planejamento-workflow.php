			...
			<div class="row ml-2 mr-2">
				<div class="col-md-12 ">
					...
					<p class="mb-5 d-flex justify-content-center">
						...
						?>
							<a href data-toggle="modal" data-target="#GravarTarefa" class="btn btn-light ml-2 mr-2 pointer"> Adicionar Marco</a>
							<br>

							<a href="cadastro-atividade-workflow.php?cod=<?php echo $registros['id'] ?>" class="btn btn-light ml-2 mr-2 pointer"> Adicionar Atividade</a>
							<br>

							<a href="cadastro-tarefa-workflow.php?cod=<?php echo $registros['id'] ?>" class="btn btn-light ml-2 mr-2 pointer"> Adicionar Tarefa</a>
							<br>
						<?php } ?>
					</p>
					<?php
