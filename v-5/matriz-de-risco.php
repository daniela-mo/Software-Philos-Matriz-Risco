    ...
    <div class="container-fluid">
      ...
      <div class="row ml-4 mr-4">
        <div class="col-md-12">
          ...
          <!-- <a class="mb-4 pointer" data-toggle="modal" data-target="#ModalNovoRisco"> <img src="imgs/icone-mais.png" width="25" height="25" alt="" /> Cadastro do Risco</a>
                ...
                <div id="carregar-tabela-identificacao" style="width:100%"></div>
          ...
          <div>
            ...
            <div class="row">
              ...
              <!-- <div class="col-md-3 mb-4"> -->
              <!-- <label>Origem <i class="fa fa-edit pointer" data-toggle="modal" data-target="#exampleModal2" onClick="EditarAtualizarOrigem()"></i></label> -->
              <!-- <label>Origem </label>
              ...
              <div class="d-flex">
                ...
                <div class="col-md-3 mb-4">
                  ...
                  <input type="text" name="cad-area-risco" id="cad-area-risco" value="<?php echo $registros[''] ?>" class="form-control" readonly>
                </div> -->
                ...
                <!-- <div class="col-md-3 mb-4">
                  ...
                  // $criterio_qaa = $risco_qaa['criterio_correspondente'];
                  $selecao_qaa_risco = mysqli_query($conexao, "select * from item_qaa_risco WHERE codigo_matriz_risco='$criterio_qaa'");
                  $risco_qaa = mysqli_fetch_array($selecao_qaa_risco);
                  ?>
                  <label>Item Qaa
                    <?php
                    $verificar_grupo = mysqli_query($conexao, "select * from grupos_permissoes WHERE codigo_menu='19' and codigo_grupo='$cod_grupo' and editar='1' ");
                    ...
                    ?>
                      ...
                      <i class="fa fa-edit pointer" data-toggle="modal" data-target="#exampleModalQaa" onClick="EditarAtualizarQaa(<?php echo $risco_qaa['id'] ?>)"></i>

                    <?php } ?>


                  </label>
                  <input type="text" name="cad-item-qaa" id="cad-item-qaa" value="<?php echo $risco_qaa['criterio_correspondente'] ?>" class="form-control" readonly>
                </div> -->
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body pt-3 pb-3 mt-2 mb-5">
                    ...
                    $selecao_empresa = mysqli_query($conexao, "select * from identificacao_do_risco WHERE empresa='$planta'");
                    ...
                    <select class="form-control" id="cad-nova-planta">
                      <?php
                      $selecao_empresa = mysqli_query($conexao, "select * from empresas order by razao_social ASC");
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body pt-3 pb-3 mt-2 mb-5">
                    ...
                    $selecao_qaa = mysqli_query($conexao, "select * from item_qaa_risco WHERE criterio_correspondente='$criterio_qaa'");
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="mt-5">
                  ...
                  <div id="carregar-tabela-avaliacao" style="width:100%"></div>
                ...
                <div class="col-md-12 mt-3 mb-4">
                  ...
                  <a data-toggle="modal" data-target="#ModalControles" style="padding-top:10px;padding-left:8px;padding-right:8px;padding-bottom:10px;margin-bottom:10px;border-radius:5px;background:#031335;color:#fff"> CONTROLES EXISTENTES</a>
          ...
          <div id="conteudo3">
            <div class="row">
              <div class="col-md-12">
                <h3>TRATAMENTO</h3>
                <!-- <a class="mb-4 pointer" href="http:cadastro-planejamento-workflow.php" data-target="#ModalNovoPlanejamento"> <img src="imgs/icone-mais.png" width="25" height="25" alt="" /> Cadastro do Tratamento</a> -->
                <a class="btn btn-light pointer" data-toggle="modal" data-target="#ModalNovoPlanejamento"> Cadastro do Tratamento</a>
          ...
          <div id="conteudo4">
            <div class="row">
              <div class="col-md-12">
                <h3>MONITORAMENTO</h3>
                <!-- <a class="mb-4 pointer" href="http:cadastro-planejamento-workflow.php" data-target="#ModalNovoPlanejamento"> <img src="imgs/icone-mais.png" width="25" height="25" alt="" /> Cadastro do Tratamento</a> -->
                <a class="btn btn-light pointer" data-toggle="modal" data-target="#ModalNovoMonitoramento" onClick="apagaForm()"> Cadastro do Monitoramento</a>
          ...
          <div class="modal fade" id="ModalControles" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index: 99999999999">
            <div class="modal-dialog modal-lg" role="document">
              ...
              ntes da execução ou registro)"> Preventivo (impedem os erros antes da execução ou registro)
                      <br>
        ...
        <div class="modal fade" id="ModalNovoMonitoramento" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index: 99999999999999999999999999">
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Novo Monitoramento</h5>
                ...
                <div class="row ml-4 mr-4 mt-4 mb-4">
                  ...
                  <div>
                    ...
                    <div class="mt-1 px-0 py-0" style="width:700px;height:350px;">
                      <h5 style="font-weight:500;">MÉTRICAS PARA ACOMPANHAMENTO DAS AÇÕES</h5>
