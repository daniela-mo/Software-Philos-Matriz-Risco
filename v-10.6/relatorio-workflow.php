	...
	?>
			...
			<tr>
				...
				<th>
					...
					<?php
					//////////////////////////////// CRITÉRIO QAA //////////////////////////////////////////*
					$selecao_criterio = mysqli_query($conexao, "select * from item_qaa_risco WHERE codigo_matriz_risco='$codigo_matriz_risco'");
					while ($registros_criterio = mysqli_fetch_array($selecao_criterio)) {

						echo $registros_criterio['criterio_correspondente'];
						echo "\n <br>"; ?>
					<?php } ?>
				...
				<th>
					...
					while ($registros_controles_existentes = mysqli_fetch_array($selecao_controles_existentes)) {
						...
						echo $registros_controles_existentes['nome_controle'];
						echo "\n <br>";
					}
					?>
				</th>
				...
				<th>
					...
					while ($registros_controles_existentes = mysqli_fetch_array($selecao_controles_existentes)) {
						...
						echo $registros_controles_existentes['objetivo_controle'];
						echo "\n <br>";
					}
					?>
				</th>
				...
				<th>
					<?php $selecao_controles_existentes = mysqli_query($conexao, "select * from controles_existentes_tratamento WHERE codigo_matriz_risco='$codigo_matriz'");
					while ($registros_controles_existentes = mysqli_fetch_array($selecao_controles_existentes)) {
						echo $registros_controles_existentes['numero_controle'];
						echo "\n <br>";
					}
					?>
				</th>
				...
				<th>
					<?php
					$selecao_workflow = mysqli_query($conexao, "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz'");
					while ($registros_workflow = mysqli_fetch_array($selecao_workflow)) {

						echo  $registros_workflow['planejamento'];
						echo "\n <br>"; ?>
					<?php }
					?>
				</th>
				...
				<th>
					...
					while ($registros_workflow = mysqli_fetch_array($selecao_workflow)) {
						...
						echo  $registros_workflow['responProc'];
						echo "\n <br>"; ?>
				...
				<th>
					...
					while ($registros_workflow = mysqli_fetch_array($selecao_workflow)) {
						...
						echo $registros_workflow['status'];
						echo "\n <br>";
					}
					echo "\n <br>";
					?>
