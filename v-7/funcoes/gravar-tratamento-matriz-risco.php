...
$gravar = mysqli_query($conexao, "insert into workflow(codigo_matriz_risco,planejamento,prioridade,data_inicio,data_vencimento,tratamento,status,responProc,causa)values('$codigo','$descricao','$prioridade','$data_min','$data_max','1','Aberto','$responProc','$causa') ");
