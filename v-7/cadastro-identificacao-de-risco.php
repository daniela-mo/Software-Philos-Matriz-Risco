	...
	<script>
		...
		function AdicionarAreaPrincipal() {
			...
			if (codigo_area_principal != '0') {
				$c.ajax({
					type: 'post',
					data: 'codigo=<?php echo $_REQUEST['id'] ?>&area=' + codigo_area_principal,
		...
		function AdicionarOutrasAreas() {
			...
			if (codigo_demais_areas != '0') {
				$c.ajax({
					type: 'post',
					data: 'codigo=<?php echo $_REQUEST['id'] ?>&area=' + codigo_demais_areas,
		...
		function AdicionarItensQaa() {
			...
			if (codigo_qaa_risco != '0') {
				$c.ajax({
					type: 'post',
					data: 'codigo=<?php echo $_REQUEST['id'] ?>&titulo=' + codigo_qaa_risco,
