    ...
    <div class="container-fluid">
          ...
          <div id="conteudo1">
            ...
            <div class="row">
              ...
              <div class="col-md-11 mb-4">
                ...
                while ($registros = mysqli_fetch_array($selecao)) {
                  ...
                  <div class="d-flex justify-content-center align-items-center ">
                    ...
                    <?php
                    $verificar_grupo = mysqli_query($conexao, "select * from grupos_permissoes WHERE codigo_menu='35' and codigo_grupo='$cod_grupo' and editar='1' ");
              ...
              <div>
                <label>Demais áreas impactadas pelo risco
                  ...
                  $verificar_grupo = mysqli_query($conexao, "select * from grupos_permissoes WHERE codigo_menu='35' and codigo_grupo='$cod_grupo' and excluir='1' ");
                  $numero_grupo = mysqli_num_rows($verificar_grupo);
                  if ($numero_grupo >= 1) {
                  ?>
            ...
            <div class="col-md-12 causaEfeito px-0 mt-3">
              ...
              <div class="col-md-6 mb-3 d-flex flex-column ml-0 mr-2 pl-0 pr-0">
                ...
                <h4>Causa</h4>
                <?php
                $verificar_grupo = mysqli_query($conexao, "select * from grupos_permissoes WHERE codigo_menu='35' and codigo_grupo='$cod_grupo' and cadastrar='1' ");
                $numero_grupo = mysqli_num_rows($verificar_grupo);
                if ($numero_grupo >= 1) {
                ?>
                    ...
                    <div class="col-md-11 mb-4">
                      ...
                      while ($registros = mysqli_fetch_array($selecao)) {
                        ...
                        <div class="d-flex justify-content-center align-items-center ">
                          ...
                          <input type="text" class="form-control w-100" name="cad-evento-risco" id="cad-evento-risco" value="<?php echo $registros['evento_risco'] ?>" readonly>
                          <?php
                          $verificar_grupo = mysqli_query($conexao, "select * from grupos_permissoes WHERE codigo_menu='36' and codigo_grupo='$cod_grupo' and cadastrar='1' ");
                          $numero_grupo = mysqli_num_rows($verificar_grupo);
                          if ($numero_grupo >= 1) {
                          ?>
                            <i class=" fa fa-edit ml-2" style="cursor: pointer" onClick="EditarAtualizarRisco(<?php echo $registros['id'] ?>)" data-toggle="modal" data-target="#exampleModal2"></i>
                    ...
                    <div style="margin-right:80px">
                      <label>Principais áreas impactadas pelo risco
                        ...
                        ?>
                          <i class="fa fa-plus" style="cursor: pointer" onClick="ModalAdicionarAreaPrincipal()" data-dismiss="modal"></i>
                        <?php  }
                        $verificar_grupo = mysqli_query($conexao, "select * from grupos_permissoes WHERE codigo_menu='36' and codigo_grupo='$cod_grupo' and excluir='1' ");
                        $numero_grupo = mysqli_num_rows($verificar_grupo);
                        if ($numero_grupo >= 1) {
                        ?>
                          <i class="fa fa-trash pointer" onClick="ExcluirAreaPrincipal()"></i>
                ...
                <div class="col-md-12 mt-3 mb-4">
                  ...
                  <div class="table-responsive">
                    ...
                    <div class="mt-5 w-100">
                      <table id="controles" class="display table mb-2">
                        <thead>
                          <tr>
        ...
        <div id="conteudo3">
          <div class="row">
            <div class="col-md-12">
              ...
              <?php
              $verificar_grupo = mysqli_query($conexao, "select * from grupos_permissoes WHERE codigo_menu='37' and codigo_grupo='$cod_grupo' and cadastrar='1' ");
              $numero_grupo = mysqli_num_rows($verificar_grupo);
              if ($numero_grupo >= 1) {
              ?>
              ...
              <div class="table-responsive">
                ...
                <form method="POST" action="matriz-de-risco.php?cod=<?php echo $codigo ?>&aba=tratamento" class="d-flex w-100">
                ...
                <table id="example" class="display table">
                  ...
                  <thead>
                    <tr>
                      ...
                      <?php
                      $verificar_grupo = mysqli_query($conexao, "select * from grupos_permissoes WHERE codigo_menu='37' and codigo_grupo='$cod_grupo' and editar='1' ");
                      $numero_grupo = mysqli_num_rows($verificar_grupo);
                      if ($numero_grupo >= 1) {
                      ?>
                        <th style="width:40px">Editar</th>
                      <?php }
                      $verificar_grupo = mysqli_query($conexao, "select * from grupos_permissoes WHERE codigo_menu='37' and codigo_grupo='$cod_grupo' and excluir='1' ");
                      $numero_grupo = mysqli_num_rows($verificar_grupo);
                      if ($numero_grupo >= 1) {
                      ?>
                  ...
                  <tbody>
                    ...
                    if ($filter_status == 'aberto') {
                      ...
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and risco='Risco Residual'";
                    } elseif ($filter_risco == 'inerente') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and risco='Risco Inerente'";
                    } elseif ($filter_risco == 'futuro') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and risco='Risco Futuro'";
                    } elseif ($filter_prioridade == 'alta') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and prioridade='Alta'";
                    } elseif ($filter_prioridade == 'media') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and prioridade='Média'";
                    } elseif ($filter_prioridade == 'baixa') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and prioridade='Baixa'";
                    } elseif ($filter_responsavel != '') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and responProc='$filter_responsavel'";
                    }
                    // ----------------------------------------------------------------- FILTRO DINÂMICO STATUS E RISCO INERENTE------------------------------------------------------------------------
                    elseif ($filter_status == 'aberto' && $filter_risco == 'inerente') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and risco='Risco Inerente' and status='Aberto'";
                    } elseif ($filter_status == 'concluido' && $filter_risco == 'inerente') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and risco='Risco Inerente' and status='Concluído'";
                    } elseif ($filter_status == 'andamento' && $filter_risco == 'inerente') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and risco='Risco Inerente' and status='Em andamento'";
                    } elseif ($filter_status == 'niniciado' && $filter_risco == 'inerente') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and risco='Risco Inerente' and status='Não iniciado'";
                    }
                    // ----------------------------------------------------------------- FILTRO DINÂMICO STATUS E RISCO RESIDUAL------------------------------------------------------------------------

                    elseif ($filter_status == 'aberto' && $filter_risco == 'residual') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and risco='Risco Residual' and status='Aberto'";
                    } elseif ($filter_status == 'concluido' && $filter_risco == 'residual') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and risco='Risco Residual' and status='Concluído'";
                    } elseif ($filter_status == 'andamento' && $filter_risco == 'residual') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and risco='Risco Residual' and status='Em andamento'";
                    } elseif ($filter_status == 'niniciado' && $filter_risco == 'residual') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and risco='Risco Residual' and status='Não iniciado'";
                    }
                    // ----------------------------------------------------------------- FILTRO DINÂMICO STATUS E RISCO FUTURO------------------------------------------------------------------------

                    elseif ($filter_status == 'aberto' && $filter_risco == 'futuro') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and risco='Risco Futuro' and status='Aberto'";
                    } elseif ($filter_status == 'concluido' && $filter_risco == 'futuro') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and risco='Risco Futuro' and status='Concluído'";
                    } elseif ($filter_status == 'andamento' && $filter_risco == 'futuro') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and risco='Risco Futuro' and status='Em andamento'";
                    } elseif ($filter_status == 'niniciado' && $filter_risco == 'futuro') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and risco='Risco Futuro' and status='Não iniciado'";
                    }
                    ...
                    elseif ($filter_status == 'aberto' && $filter_prioridade == 'alta') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and prioridade='Alta' and status='Aberto'";
                    } elseif ($filter_status == 'aberto' && $filter_prioridade == 'media') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and prioridade='Média' and status='Aberto'";
                    } elseif ($filter_status == 'aberto' && $filter_prioridade == 'futuro') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and prioridade='Baixa' and status='Aberto'";
                    }
                    // ----------------------------------------------------------------- FILTRO DINÂMICO PRIORIDADE E STATUS EM ANDAMENTO ------------------------------------------------------------------------
                    elseif ($filter_status == 'andamento' && $filter_prioridade == 'alta') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and prioridade='Alta' and status='Em andamento'";
                    } elseif ($filter_status == 'andamento' && $filter_prioridade == 'media') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and prioridade='Média' and status='Em andamento'";
                    } elseif ($filter_status == 'andamento' && $filter_prioridade == 'baixa') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and prioridade='Baixa' and status='Em andamento'";
                    }
                    // ----------------------------------------------------------------- FILTRO DINÂMICO PRIORIDADE E STATUS NÃO INICIADO ------------------------------------------------------------------------
                    elseif ($filter_status == 'niniciado' && $filter_prioridade == 'alta') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and prioridade='Alta' and status='Não iniciado'";
                    } elseif ($filter_status == 'niniciado' && $filter_prioridade == 'media') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and prioridade='Média' and status='Não iniciado'";
                    } elseif ($filter_status == 'niniciado' && $filter_prioridade == 'baixa') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and prioridade='Baixa' and status='Não iniciado'";
                    }
                    ...
                    elseif ($dtFinal != '' && $dtInicio != '') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and data_inicio and data_vencimento between '$dtInicio' and '$dtFinal'";
                    }

                    // ----------------------------------------------------------------- FILTRO DINÂMICO DATAS E RISCO ------------------------------------------------------------------------
                    elseif ($dtFinal != '' && $dtInicio != '' && $filter_risco == 'inerente') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and data_inicio and data_vencimento between '$dtInicio' and '$dtFinal' and risco='Risco Inerente'";
                    } elseif ($dtFinal != '' && $dtInicio != '' && $filter_risco == 'residual') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and data_inicio and data_vencimento between '$dtInicio' and '$dtFinal' and risco='Risco Residual'";
                    } elseif ($dtFinal != '' && $dtInicio != '' && $filter_risco == 'futuro') {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and data_inicio and data_vencimento between '$dtInicio' and '$dtFinal' and risco='Risco Futuro'";
                    } else {
                      $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz'";
                    }


                    // $sql = "select * from workflow WHERE codigo_matriz_risco='$codigo_matriz' and data_inicio='$dtInicio' and data_vencimento='$dtFinal'";
        ...
        <div id="conteudo4">
          <div class="row">
            <div class="col-md-12">
              ...
              <!-- <a class="mb-4 pointer" href="http:cadastro-planejamento-workflow.php" data-target="#ModalNovoPlanejamento"> <img src="imgs/icone-mais.png" width="25" height="25" alt="" /> Cadastro do Tratamento</a> -->
              <?php
              $verificar_grupo = mysqli_query($conexao, "select * from grupos_permissoes WHERE codigo_menu='38' and codigo_grupo='$cod_grupo' and cadastrar='1' ");
              $numero_grupo = mysqli_num_rows($verificar_grupo);
              if ($numero_grupo >= 1) {
              ?>
                  ...
                  <table id="example-monitoramento" class="display table">
                    <thead>
                      <tr>
                        ...
                        <?php
                        $verificar_grupo = mysqli_query($conexao, "select * from grupos_permissoes WHERE codigo_menu='38' and codigo_grupo='$cod_grupo' and editar='1' ");
                        $numero_grupo = mysqli_num_rows($verificar_grupo);
                        if ($numero_grupo >= 1) {
                        ?>
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr style="height:150px;">
                          ...
                          <?php }
                          $verificar_grupo = mysqli_query($conexao, "select * from grupos_permissoes WHERE codigo_menu='38' and codigo_grupo='$cod_grupo' and excluir='1' ");
                          $numero_grupo = mysqli_num_rows($verificar_grupo);
                          if ($numero_grupo >= 1) {
                          ?>
                            <td style="text-align:left">
      ...
      <script>
        ...
        $y(document).ready(function() {
          ...
          // $y('#example-monitoramento').DataTable();
        ...
        function ExcluirTratamento(codigo) {
          if (window.confirm("Você deseja excluir o Tratamento?")) {
            ...
            $g.ajax({
              type: 'post',
              data: 'codigo=' + codigo,
              url: 'funcoes/excluir-tratamento.php',
              success: function(retorno) {
                $g('#resposta-matriz').html(retorno);
      ...
      <script>
        ...
        function filtrar() {
          var filter_status = $f('#filter_status option:selected').val()
