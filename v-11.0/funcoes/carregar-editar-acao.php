...
<div class="row ml-4 mr-4">
    ...
    <div class="col-md-12 row">
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="editar-responsavel-acao" id="editar-responsavel-acao" value="<?php echo $registros['responsavel'] ?>">

        </div>
        <div class="col-md-6">
            <label>Área</label>
            <input type="text" class="form-control" name="editar_area_acao" id="editar_area_acao" value="<?php echo $registros['area'] ?>">

        </div>

        <div class="col-md-6">
            <label>Data</label>
            <input type="date" class="form-control" name="editar-data-acao" id="editar-data-acao" value="<?php echo $registros['data'] ?>">
