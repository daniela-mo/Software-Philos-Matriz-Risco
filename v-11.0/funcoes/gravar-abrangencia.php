...
$gravar = mysqli_query($conexao, "insert into detalhe_abrangencia(descricao,codigo,area,responsavel)values('$descricaoAbrangencia','$id','$area_abrangencia','$resposanvel_abrangencia')");
