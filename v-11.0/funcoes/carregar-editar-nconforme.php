...
<div class="row ml-4 mr-4">
    ...
    <div class="col-md-12 row">
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="editar-responsavel-nconforme" id="editar-responsavel-nconforme" value="<?php echo $registros['responsavel'] ?>">

        </div>
        <div class="col-md-6">
            <label>Área</label>
            <input type="text" class="form-control" name="editar_area_nconforme" id="editar_area_nconforme" value="<?php echo $registros['area'] ?>">
