												...
												<div class="collapse list-group-level3" id="sub-sub-sub-menu<?php echo $a ?>_<?php echo $b ?>_<?php echo $c ?>">
													...
													?>
														...
														<div class="list-group-item">
															...
															<?php
															$selecao44 = mysqli_query($conexao, "select * from questoes_qaa WHERE salvar='$salvar'  ");
															...
															if ($registros44['salvar'] == '1') { ?>
																...
																<i class="fa fa-check icone-geral" style="color: green; float:left" id="codigo2-<?php echo $codigo_id ?>" <?php print $_SESSION['check'] ?>> </i> &nbsp;
