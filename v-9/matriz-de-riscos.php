...
<body class=" fixed-nav sticky-footer" id="page-top">
            ...
            <div class="row ml-4 mr-4 ">
                <div class="col-md-12 mt-5">
                    ...
                    ?>
                        ...
                        <a href="cadastro-identificacao-de-risco.php" id="areasStatus1" style="padding-top:10px;padding-left:8px;padding-right:8px;padding-bottom:10px;margin-bottom:10px;border-radius:5px;background:#031335;color:#fff;text-decoration:none"> Novo Evento de Risco </a>

                    <?php } ?>

                    <h3 class="mb-4 mt-4">Processo de Avaliação de Risco</h3>
                    <?php
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="example" class="display" style="width:100%">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Descrição do Evento do Risco </th>
                                    <th>Origem</th>
	...
	*/
    ...
    <script>
        ...
        // function apagarAreasStatus1() {

        // }


        var areasStatus1 = document.getElementById('areasStatus1');
        areasStatus1.addEventListener("mouseover", function() {

            $.ajax({
                type: 'post',
                // data: 'codigo=' + codigo,
                url: 'funcoes/excluir-areas-status-1.php',
                success: function(retorno) {
                    location.reload()
