        ...
        <tr class="col-md-8 mt-3 mb-2">
            <th>
                ...
                <select class="form-control" name="empresa" id="empresa">
                    ...
                    <?php
                    if ($registros['razao_social'] != '') {
                        $id_empresa = $registros['empresa'];
                        $selecao_empresa = mysqli_query($conexao, "select * from filias WHERE id='$id_empresa'");
                        $reg = mysqli_fetch_array($selecao_empresa);
                    ?>
                        <option value="<?php echo $registros['razao_social'] ?>"> <?php echo $reg['empresa'] ?></option>
                    <?php } else { ?>
                    ...
                    $selecao_areas = mysqli_query($conexao, "select * from filiais order by razao_social ASC");
                    while ($registros_areas = mysqli_fetch_array($selecao_areas)) {

                        if ($registros['razao_social'] != $registros_areas['razao_social']) {
                    ?>
                            <option value="<?php echo $registros_areas['razao_social'] ?>"><?php echo $registros_areas['razao_social'] ?></option>

                    <?php }
                    } ?>
                    <?php

                    $selecao_areas = mysqli_query($conexao, "select * from empresas order by razao_social ASC");
                    while ($registros_areas = mysqli_fetch_array($selecao_areas)) {
