              ...
              <div class="row">
                ...
                <div style="margin-right:80px">
                  <label>Principais áreas impactadas pelo risco
                    ...
                    <i class=" fa fa-plus" style="cursor: pointer" onClick="EditarAreaPrincipal(<?php echo $registros['id'] ?>)" data-toggle="modal" data-target="#ModalAreaPrincipal"></i>
                  </label>
                  <?php
                  ...
                  ?>
                    ...
                    <div class="d-flex mb-2 align-items-center">
                      ...
                      <i class=" fa fa-edit" style="cursor: pointer" onClick="EditarAreaPrincipal(<?php echo $registros['id'] ?>)" data-toggle="modal" data-target="#ModalAreaPrincipal"></i>
                    </div>
                ...
                <div>
                  <label>Demais áreas impactadas pelo risco
                    ...
                    <i class=" fa fa-plus" style="cursor: pointer" onClick="EditarDemaisAreas(<?php echo $registros['id'] ?>)" data-toggle="modal" data-target="#ModalEditarDemaisAreas"></i>
                  </label>
                  <?php
                  ...
                  ?>
                    <div class="d-flex mb-2 align-items-center" style="flex-direction:row">
                      <input type="text" readonly class="form-control mr-2" value="<?php echo $registros_principal['area'] ?>">
                      <i class=" fa fa-edit" style="cursor: pointer" onClick="EditarDemaisAreas(<?php echo $registros['id'] ?>)" data-toggle="modal" data-target="#ModalEditarAreaPrincipal"></i>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr style="height:150px">
                        ...
                        <td style="text-align:center;"><a class="text-dark" href="planejamento-workflow.php?cod=<?php echo $registros['id'] ?>"><?php echo $registros['prioridade'] ?></a></td>
                ...
                <table id="example-monitoramento" class="display table">
                  <thead>
                    <tr>
                      ...
                      <th style="width:150px;text-align:center;">Periodicidade</th>
                      <th style="width:200px;text-align:center;">Responsável</th>
                      <th style="width:175px;text-align:center;">Objetivo atendido?</th>
                      <th style="width:285px;text-align:center;">Indicação de necessidade de revisão</th>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr style="height:150px;">
                        ...
                        <td style="margin-right:40px;text-align:center;padding-left:16px;"><?php echo $registros['periodicidade'] ?></td>


                        <td style="margin-right:90px;text-align:center;padding-left:16px;">
                          <?php echo $registros['responsavel'] ?>
                        </td>
                        <td style="width:175px;margin-right:40px;text-align:center;">
                          <?php echo $registros['objetivo_sim_nao'] ?>
                        </td>
                        <td style="width:285px;margin-right:20px;text-align:center;">
