...
<textarea rows="3" class="form-control textarea" id="quest-questao"><?php echo $regsitros['questao'] ?><?php echo $regsitros['questao_principal'] ?></textarea>
...
--->
	...
	<input type="radio" <?php if ($registros_resposta['resposta_sim_nao'] == 'Não') { ?> checked <?php } ?> name="cad-resposta-sim-nao" id="cad-resposta-sim-nao" value="Não"> Não
...
<script>
	...
	$h(document).ready(function() {
		...
		$h('#quest-resposta').css('height', test + 1000)
