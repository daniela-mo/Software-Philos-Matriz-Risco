...
<div class="row ml-4 mr-4 mt-3">
    ...
    <div class="col-md-8">
        <table id="tabela_principal" class="display table-striped" style="width:100%">
            <!-- <thead>
                <tr>
                    <th>Área</th>
            ...
            <tbody>
                ...
                $selecao = mysqli_query($conexao, "select * from area_principal_risco");
