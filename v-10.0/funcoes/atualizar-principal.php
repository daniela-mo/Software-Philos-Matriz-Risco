...
// $selecao_principal = mysqli_query($conexao, "select * from area_principal_risco WHERE id='$id");
// $registros_principal = mysqli_fetch_array($selecao_principal);
// $area = $registros_principal['area'];
// $id = $registros_principal['id'];


$gravar = mysqli_query($conexao, "update area_principal_risco set area='$nome_area',codigo_area='$codigo_area' WHERE codigo_matriz_risco='$codigo' and id='$id'");
