...
if ($excluir) {
    ...
    $exclui6 = mysqli_query($conexao, "delete from monitoramento_risco WHERE codigo_matriz='$codigo'");
    $exclui7 = mysqli_query($conexao, "delete from matriz_de_risco_causas WHERE codigo_matriz='$codigo'");
    $exclui8 = mysqli_query($conexao, "delete from diagrama_ishikawa_efeitos WHERE codigo_matriz='$codigo'");


    $alterar =  mysqli_query($conexao, "delete from area_principal_risco WHERE codigo_matriz_risco='$codigo'");
    $alterar2 =  mysqli_query($conexao, "delete from demais_areas_risco WHERE codigo_matriz_risco='$codigo'");
    $alterar3 =  mysqli_query($conexao, "delete from item_qaa_risco WHERE codigo_matriz_risco='$codigo'");
?>
