...
<label><a onClick="AddArea()" id="add-area12">Demais Área impactada pelo risco </a></label>
...
<input type="button" value="gravar" class="mb-3 cad-area-apoio w-25 py-1 rounded btn-primary" onClick="GravarArea()">

<table id="example" class="display table-striped mb-4" style="width:50%">
	<thead>
		<?php
		$selecao = mysqli_query($conexao, "select * from areas_apoio_risco WHERE codigo_usuario='$id_usuario'");
		$numero = mysqli_num_rows($selecao);
		if ($numero == '0') {
		?>

			<tr>
				<td>Escolher Empresa Antes</td>
			</tr>
