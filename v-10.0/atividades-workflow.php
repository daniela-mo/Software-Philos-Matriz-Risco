 				...
 				<div class="col-md-12">
 					...
 					<?php
						...
						?>
 						...
 						<a href="cadastro-tarefa-workflow.php?cod=<?php echo $registros['id'] ?>" style="padding-top:10px;padding-left:8px;padding-right:8px;padding-bottom:10px;border-radius:5px;background:#031335;color:#fff;text-decoration:none;cursor:pointer;"> Nova Tarefa</a>
 					<?php } ?>
