...
<body class=" fixed-nav sticky-footer" id="page-top">
		...
		<div class="container-fluid">
			<div class="row mb-5" style="margin-top: -16px; ">
				<div class="col-md-12 bg-padrao position-fixed p-2 text-right" style="z-index: 999999">
					...
					<div class="row">
						<div class="col-md-9">
							<span class="text-white breadcrumb-item"><a href="dashboard.php" class="text-light">Software Philos</a> | Atualizar Planejamento</span>
						</div>
					</div>
			...
			<div class="row ml-2 mr-2">
				<div class="col-md-12 ">
					...
					<p class="mb-5 d-flex justify-content-center">
						...
						?>
							<a href data-toggle="modal" data-target="#GravarTarefa" class="btn btn-light ml-2 mr-2 pointer" style="padding-top:10px;padding-left:8px;padding-right:8px;padding-bottom:10px;margin-bottom:10px;border-radius:5px;background:#031335;color:#fff;text-decoration:none;cursor:pointer;"> Adicionar Marco</a>
							<br>

							<a href="cadastro-atividade-workflow.php?cod=<?php echo $registros['id'] ?>" class="btn btn-light ml-2 mr-2 pointer" style="padding-top:10px;padding-left:8px;padding-right:8px;padding-bottom:10px;margin-bottom:10px;border-radius:5px;background:#031335;color:#fff;text-decoration:none;cursor:pointer;"> Adicionar Atividade</a>
							<br>

							<a href="cadastro-tarefa-workflow.php?cod=<?php echo $registros['id'] ?>" class="btn btn-light ml-2 mr-2 pointer" style="padding-top:10px;padding-left:8px;padding-right:8px;padding-bottom:10px;margin-bottom:10px;border-radius:5px;background:#031335;color:#fff;text-decoration:none;cursor:pointer;"> Adicionar Tarefa</a>
							<br>
						<?php } ?>
					</p>
					<?php
					...
					<div class="row mb-4">
						...
						<div class="col-md-10">
							...
							<input type="text" class="form-control bg-white" id="planejamento" value="<?php echo $registros1['planejamento'] ?>" style="font-size: 22px; font-weight: 800;">

						</div>

						<div class="col-md-3 mt-3">
							<label>Responsável</label>
							<input type="text" class="form-control bg-white" id="responProc" value="<?php echo $registros1['responProc'] ?>">
			...
			<di>
				...
				<table id="example2" class="table-striped" style="width:100%;">
					...
					<tbody style="width:100%;">
						<?php
						$selecao_atividades = mysqli_query($conexao, "select * from atividades_planejamento_workflow order by atividade ASC ");
	...
	<script>
		...
		function GravarAtividade() {
			...
			// alert('entrando daqui')
			var planejamento = $f('#planejamento').val()
			var codigo = $f('#codigo_planejamento').val()
			var descricao = $f('#nome-descricao').val()
			var responProc = $f('#responProc').val()

			// alert('passando daqui1')
			var inicio = $f('#cad-data-inicio').val()
			// alert('passando daqui2')
			...
			if (dia1 > 31) {
				...
				if (dia2 > 31) {
					...
					var periodicidade = $f('#cad-periodicidade1').val()
					var area = $f('#cad-area option:selected').val()

					// alert('passando daqui5')

					$f.ajax({

						type: 'post',
						data: '&codigo=<?php echo $codigo ?>&planejamento=' + planejamento + '&descricao=' + descricao +
							'&inicio=' + inicio + '&vencimento=' + vencimento + '&status=' + status + '&periodicidade=' + periodicidade + '&area=' + area + '&responProc=' + responProc,
						url: 'funcoes/atualizar-workflow.php',
