...
<table>
	...
	?>
			...
			<tr>
				...
				<th>
					<?php $selecao_controles_existentes = mysqli_query($conexao, "select * from controles_existentes_tratamento WHERE codigo_matriz_risco='$codigo_matriz_risco'");
					$registros_controles_existentes = mysqli_fetch_array($selecao_controles_existentes);
