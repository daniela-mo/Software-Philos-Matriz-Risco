  ...
  <div class="content-wrapper">
    <div class="container-fluid">
              ...
              <div style="margin-right:80px">
                ...
                ?>
                  ...
                  <div class="d-flex mb-2 align-items-center">
                    ...
                    <i class=" fa fa-edit pointer" onClick="modalPrincipalArea()" data-dismiss="modal"></i>
                  </div>
              ...
              <div>
                ...
                ?>
                  <div class="d-flex mb-2 align-items-center" style="flex-direction:row">
                    ...
                    <i class=" fa fa-edit pointer" onClick="ModalEditarDemaisAreas()" data-dismiss="modal"></i>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body pt-3 pb-3 mt-2 mb-5">
                ...
                <input type="button" class="btn btn-primary mt-3" value="Atualizar Area Principal" onClick="AtualizarAreaPrincipal()" data-dismiss="modal" aria-label="Close">
              ...
              <form id="form-causa">
                <div class="">
                  ...
                  <div class="mb-4">
                    ...
                    <input type="button" value="Adicionar Nova Area Principal" class="btn btn-primary mt-3" onClick="AdicionarAreaPrincipal()" data-dismiss="modal" aria-label="Close">
      ...
      <script>
        ...
        function modalPrincipalArea() {

          document.getElementById('form-causa').reset();


          $g('.pos-area').hide()
          $g('#modalPrincipalArea').modal('show');
        ...
        function AtualizarAreaPrincipal(codigo, id) {
