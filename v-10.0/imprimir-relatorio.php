						...
						?>
							...
							?>
								...
								<div class="col-md-12  ml-5" style="border:solid 1px #9F9F9F; padding: 10px 5px; border-radius:10px">
									...
									<div class="ml-4">
										<?php if ($resposta == '') {
											echo "<p class='text-danger'>Não Respondido</p>";
										} else {
											echo "<p class='text-success'>" . $resposta . "</p>";
										}  ?>
								...
								<?php
								$selecao3 = mysqli_query($conexao, "select * from upload_qaa WHERE codigo_qaa='$id3'    ");
								while ($registros3 = mysqli_fetch_array($selecao3)) {
									$arquivo = $registros3['arquivo'];

									if ($arquivo == '') {
										echo "<p class='text-danger'>Não há arquivo</p>";
									} else {

								?>
										<div class="col-md-12  ml-5" style="border:solid 1px #9F9F9F; padding: 10px 5px; border-radius:10px">
											<h5 class=" ml-3"><?php echo $registros3['arquivo']; ?></h5>
											<div class="ml-4">
