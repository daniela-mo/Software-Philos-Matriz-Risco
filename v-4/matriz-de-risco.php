...
<body class=" fixed-nav sticky-footer" id="page-top">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
          ...
          <div id="conteudo2">
            ...
            <div class="row">
              ...
              <div class="col-md-12 mt-3 mb-4">
                ...
                <div id="carregar-tabela-controles-existentes" style="width:100%">
                </div>
          ...
          <div id="conteudo5">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <a class="mb-4 pointer" data-toggle="modal" data-target="#ModalNovoMonitoramento"> <img src="imgs/icone-mais.png" width="25" height="25" alt="" /> Cadastro do Tratamento</a>
                ...
                <div class="w-100 d-flex">
                  ...
                  <div class="mt-5 px-0 py-0" style="width:700px;height:400px;">
                  ...
                  <div class="mt-5" style="width:750px;height:400px;">
                ...
                <div class="col-md-12 my-4">
                  <input type="button" class="btn btn-primary" value="Cadastrar Monitoramento" onClick="cadastrarMonitoramento()">
                </div>
      ...
      <div class="modal fade" id="ModalNovoRisco" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index: 99999999999999999999999999">
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalLabel">Novo Avaliacao</h5>
