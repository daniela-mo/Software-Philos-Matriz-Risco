    ...
    <div class="container-fluid">
      ...
      <div class="row ml-4 mr-4 mt-5">
        ...
        <div class="col-md-12 text-center mt-4 mb-5">
          ...
          <!-- <a href="" class="btn btn-light ml-2 mr-2 pointer">Tratamento</a> -->
      ...
      <div class="row ml-4 mr-4">
        ...
        <div id="conteudo2" style="width:100%">
          <div class="row">
            ...
            <div class="col-12 mt-3 mb-3">
              ...
              <h4 class="mb-4 mt-5"> <strong> </strong> </h4>
              <div class="w-100 row">

                <div class="col-12 causaEfeito px-0 mt-3">

                  <div class="col-6 mb-3 d-flex flex-column ml-0 mr-2 pl-0 pr-0">
                    ...
                    <div id="carregar-ishikawa" class="w-100"></div>

                  </div>

                  <div class="col-6 mb-3 d-flex flex-column ml-0 mr-0 pl-0 pr-0">
                    ...
                    <div id="carregar-ishikawa-efeito" class="w-100"></div>
        ...
        <div id="conteudo4" style="width:100%">
          <div class="row">
            <div class="col-12">
              <h3>TRATAMENTO</h3>
        ...
        <div id="conteudo5" style="width:100%">
          ...
          <div class="row col-md-12">
            ...
            <div class="col-md-12 mb-3">
              ...
              <table id="tabela-comites" class="display">
                ...
                <tbody>
                  ...
                  ?>
                    ...
                    <tr>
                      ...
                      <td><a class="text-dark" href="comite.php?cod=<?php echo $registros['id'] ?>">
                          <?php
