            ...
            <div class="col-md-12">
              ...
              <div class="w-100 d-flex">
                ...
                <div class="mt-5 px-0 py-0" style="width:700px;height:400px;">
                  <h5>MÉTRICAS PARA ACOMPANHAMENTO DAS AÇÕES</h5>
                  ...
                  <div class="col-md-10">
                    ...
                    <textarea name="" id="" class="form-control" required rows="3"></textarea>
                  </div>
              ...
              <div class="col-md-12 mt-4">
                <input type="button" class="btn btn-primary" value="Cadastrar Monitoramento" onClick="">
              </div>
